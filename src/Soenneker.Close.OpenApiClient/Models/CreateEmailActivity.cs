...
namespace Soenneker.Close.OpenApiClient.Models
{
    ...
    public partial class CreateEmailActivity : IParsable
...
#nullable enable
        public List<global::Soenneker.Close.OpenApiClient.Models.CreateEmailActivityAttachmentsItem>? Attachments { get; set; }
#nullable restore
#else
        public List<global::Soenneker.Close.OpenApiClient.Models.CreateEmailActivityAttachmentsItem> Attachments { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.Close.OpenApiClient.Models.CreateEmailActivityOpensItem>? Opens { get; set; }
#nullable restore
#else
        public List<global::Soenneker.Close.OpenApiClient.Models.CreateEmailActivityOpensItem> Opens { get; set; }
#endif
...
#nullable restore
        ...
        public global::Soenneker.Close.OpenApiClient.Models.CreateEmailActivityStatus? Status { get; set; }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Close.OpenApiClient.Models.CreateEmailActivity"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Close.OpenApiClient.Models.CreateEmailActivity CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Close.OpenApiClient.Models.CreateEmailActivity();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "attachments", n => { Attachments = n.GetCollectionOfObjectValues<global::Soenneker.Close.OpenApiClient.Models.CreateEmailActivityAttachmentsItem>(global::Soenneker.Close.OpenApiClient.Models.CreateEmailActivityAttachmentsItem.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "opens", n => { Opens = n.GetCollectionOfObjectValues<global::Soenneker.Close.OpenApiClient.Models.CreateEmailActivityOpensItem>(global::Soenneker.Close.OpenApiClient.Models.CreateEmailActivityOpensItem.CreateFromDiscriminatorValue)?.AsList(); } },
                { "organization_id", n => { OrganizationId = n.GetStringValue(); } },
                { "sender", n => { Sender = n.GetStringValue(); } },
                { "status", n => { Status = n.GetEnumValue<global::Soenneker.Close.OpenApiClient.Models.CreateEmailActivityStatus>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Soenneker.Close.OpenApiClient.Models.CreateEmailActivityAttachmentsItem>("attachments", Attachments);
            ...
            writer.WriteCollectionOfObjectValues<global::Soenneker.Close.OpenApiClient.Models.CreateEmailActivityOpensItem>("opens", Opens);
            writer.WriteStringValue("organization_id", OrganizationId);
            writer.WriteStringValue("sender", Sender);
            writer.WriteEnumValue<global::Soenneker.Close.OpenApiClient.Models.CreateEmailActivityStatus>("status", Status);
