...
namespace Soenneker.Close.OpenApiClient.Models
{
    ...
    public partial class LeadMergeActivity : IAdditionalDataHolder, IParsable
...
#nullable restore
        ...
        /// <summary>The destination_display_name property</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        public global::Soenneker.Close.OpenApiClient.Models.LeadMergeStatus? MergeStatus { get; set; }
...
#nullable restore
        ...
        public string SourceDisplayName { get; set; }
#endif
        /// <summary>The source_lead_id property</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Close.OpenApiClient.Models.LeadMergeActivity"/> and sets the default values.
        /// </summary>
        public LeadMergeActivity()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Close.OpenApiClient.Models.LeadMergeActivity"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Close.OpenApiClient.Models.LeadMergeActivity CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Close.OpenApiClient.Models.LeadMergeActivity();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "destination_display_name", n => { DestinationDisplayName = n.GetStringValue(); } },
                ...
                { "merge_status", n => { MergeStatus = n.GetEnumValue<global::Soenneker.Close.OpenApiClient.Models.LeadMergeStatus>(); } },
                { "organization_id", n => { OrganizationId = n.GetStringValue(); } },
                { "source_display_name", n => { SourceDisplayName = n.GetStringValue(); } },
                { "source_lead_id", n => { SourceLeadId = n.GetStringValue(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteStringValue("destination_display_name", DestinationDisplayName);
            ...
            writer.WriteEnumValue<global::Soenneker.Close.OpenApiClient.Models.LeadMergeStatus>("merge_status", MergeStatus);
            writer.WriteStringValue("organization_id", OrganizationId);
            writer.WriteStringValue("source_display_name", SourceDisplayName);
            writer.WriteStringValue("source_lead_id", SourceLeadId);
